 ...
 */
function uscourts_district_install_tasks_alter(&$tasks, $install_state) {
 ...
 */
function uscourts_district_form_install_configure_form_alter(&$form, $form_state) {
  ...
  function system_form_install_select_profile_form_alter (&$form, $form_state) {
    $form['profile']['Minimal']['#access']=false;
    $form['profile']['Standard']['#access']=false;
   }    
