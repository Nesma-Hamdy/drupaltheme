<?php
  ...
  function us_courts_bankruptcy_form_system_theme_settings_alter(&$form, &$form_state) { 
  ...
  /*--The code below is commended out to remove the seal selection and seal uploading function in the appearance setting.-*/   
    /*$form['theme_settings']['toggle_seal'] = array(
      '#title' => t('Seal'),
      '#type' => 'checkbox',
      '#default_value' => theme_get_setting('toggle_seal', 'us_courts_bankruptcy')
    );
    ...
    $form['seal_img']['default_seal_img'] = array(
     ...
     '#default_value' => theme_get_setting('default_seal_img', 'us_courts_bankruptcy'), 
     '#tree' => FALSE, 
   ...
   $form ['court_title_settings']['site_court']['court_title'] = array(
     ...
     '#default_value' => theme_get_setting('court_title','us_courts_bankruptcy')
   );
    ...
    $form['homepage_settings']['welcome_btns']['pacer_link'] = array(
     ...
     '#default_value' => theme_get_setting('pacer_link', 'us_courts_bankruptcy')
    );
    ...
    $form['homepage_settings']['welcome_btns']['cmecf_link'] = array(
     ...
     '#title' => t('CM/ECF link'),
     '#description' => t('Format: http://siteurl.com/'),
     '#default_value' => theme_get_setting('cmecf_link', 'us_courts_bankruptcy')
    );
    ...
    $form['homepage_settings']['welcome_btns']['wb_one'] = array(
     ...
     '#default_value' => theme_get_setting('wb_one', 'us_courts_bankruptcy')
    );
    ...
    $form['homepage_settings']['welcome_btns']['wb_two'] = array(
     ...
     '#description' => t('Format title|url.'),
     '#default_value' => theme_get_setting('wb_two', 'us_courts_bankruptcy')
    );
    
    //Welcome text
    $welcome_txt = theme_get_setting('welcome_txt', 'us_courts_bankruptcy');
    ...
    $form['theme_settings']['toggle_welcome_img'] = array(
      ...
      '#type' => 'checkbox',
      '#default_value' => theme_get_setting('toggle_welcome_img', 'us_courts_bankruptcy')
    );
    ...
    $form['homepage_settings']['welcome_img']['default_welcome_img'] = array(
     ...
     '#default_value' => theme_get_setting('default_welcome_img', 'us_courts_bankruptcy'), 
     '#tree' => FALSE, 
   ...
   $form['homepage_settings']['welcome_img']['settings']['welcome_img_upload'] = array(
    ...
    $form['#submit'][] = '_us_courts_bankruptcy_settings_submit';
    $form['#validate'][] = '_us_courts_bankruptcy_settings_validate';
  }
  
  function _us_courts_bankruptcy_settings_submit($form, &$form_state) {
  ...
  function _us_courts_bankruptcy_settings_validate($form, &$form_state) {
   // Handle file uploads.
