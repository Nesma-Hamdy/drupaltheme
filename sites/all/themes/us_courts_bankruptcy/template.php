<?php
function us_courts_bankruptcy_preprocess_html(&$vars) {
...
function us_courts_bankruptcy_preprocess_page(&$vars) {
 ...
 foreach ($add_welcome_btns as $id => $btn) {
  if (isset($btn) && $btn != '') {
   $btn = us_courts_bankruptcy_format_wb_vars($btn);
...
function us_courts_bankruptcy_menu_tree($vars) {
  return '<ul class="menu clearfix">' . $vars['tree'] . '</ul>';
}

function us_courts_bankruptcy_form_alter(&$form, &$form_state, $form_id) {
...
function us_courts_bankruptcy_preprocess_views_view(&$vars) {
 if($vars['name'] == 'faqs' && $vars['display_id'] == 'page') {
  us_courts_bankruptcy_views_field_title_subs($vars['view'], 'field_faq_type');
 }
 if($vars['name'] == 'all_forms' && $vars['display_id'] == 'all_forms') {
  us_courts_bankruptcy_views_field_title_subs($vars['view'], 'field_form_cat');
 }
}

function us_courts_bankruptcy_views_field_title_subs($view, $field_name) {
 ...
 */
function us_courts_bankruptcy_format_wb_vars($vars) {
