    ...
    <div id="header"><div class="section clearfix">
      ...
      <?php if ($site_name || $site_slogan): ?>
        <div id="name-and-slogan">
         <p id="site-court"><a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home"><?php print $court_title; ?></a></p>
          <?php if ($site_name): ?>
            <?php if ($title): ?>
        ...
        <div id="content-top" class="grid_12">
          ...
          <div class="grid_3 alpha left-top-column">
            <ul class="fp-welcome-links">
              <li><a href="<?php echo $pacer_link; ?>" target="_blank">Case Locator (PACER) &raquo;</a></li>
              <li><a href="<?php echo $cmecf_link; ?>" target="_blank">E-Filing (CM/ECF) &raquo;</a></li>
